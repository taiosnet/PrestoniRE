...
import { LUXURY_YACHTS } from '@/lib/lifestyle-data';
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 lg:px-12 pb-20 pt-40 flex flex-col items-start gap-6">
          ...
          >
            Sport yachts, superyachts, and full custom commissions — new build and brokerage
            listings from the world&apos;s finest shipyards.
          </p>
      ...
      >
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 flex flex-col gap-12">
          <SectionHeader
            ...
            subtitle={`${LUXURY_YACHTS.length} brokerage listings — from Sunseeker and Pershing sport yachts to full Feadship and Benetti custom superyachts.`}
          />

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {LUXURY_YACHTS.map((yacht) => (
              <LuxuryAssetCard key={yacht.id} asset={yacht} />
            ))}
          </div>
        </div>
      </section>
